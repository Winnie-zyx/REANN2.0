...
species_test,atom_index_test,shifts_test,volume_test,batchsize_test,min_data_len=min_data_len_test,shuffle=False)
...
#for param in getdensity.outnn.net[5].parameters():
