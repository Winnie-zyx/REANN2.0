...
getdensity = GetDensity(rs, inta, neigh_atoms, initpot, nipsin, cutoff, norbit=64, 
                        nwave=8, emb_nblock=1, emb_nl=[1,64,64], emb_layernorm=True, 
                        oc_loop=0, oc_nblock=1, oc_nl=[64,64,64], oc_dropout_p=[0.0,0.0], 
                        oc_layernorm=True, nblock=1, nl=[64,64,64], dropout_p=[0.0,0.0], 
                        layernorm=True)
#==============================nn module=================================
