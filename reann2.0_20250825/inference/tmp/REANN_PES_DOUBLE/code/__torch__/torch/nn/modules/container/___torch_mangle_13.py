class Sequential(Module):
  ...
  __annotations__["5"] = __torch__.torch.nn.modules.linear.___torch_mangle_12.Linear
  def forward(self: __torch__.torch.nn.modules.container.___torch_mangle_13.Sequential,
    input: Tensor) -> Tensor:
    _0 = getattr(self, "0")
    _1 = getattr(self, "1")
    _2 = getattr(self, "2")
  ...
  def __len__(self: __torch__.torch.nn.modules.container.___torch_mangle_13.Sequential) -> int:
    return 6
