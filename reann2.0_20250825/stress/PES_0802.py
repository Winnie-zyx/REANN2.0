...
class PES(torch.nn.Module):
    def __init__(self,nlinked=1,initpot=0):
        ...
        self.getdensity=GetDensity(neigh_atoms, initpot=self.initpot, nipsin=nipsin, cutoff=cutoff, norbit=norbit,nwave=nwave, emb_nblock=emb_nblock, emb_nl=emb_nl, emb_layernorm=emb_layernorm,oc_loop=oc_loop, oc_nblock=oc_nblock, oc_nl=oc_nl, oc_dropout_p=oc_dropout_p,oc_layernorm=oc_layernorm, nblock=nblock, nl=nl, dropout_p=dropout_p,layernorm=layernorm)
