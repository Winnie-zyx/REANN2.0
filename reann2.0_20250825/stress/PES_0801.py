...
class PES(torch.nn.Module):
    def __init__(self,nlinked=1):
        ...
        self.density=GetDensity(neigh_atoms, nipsin, cutoff, norbit,   ##initpot in density
    ...
    def forward(self,period_table,cart,cell,species,mass):
        ...
        dist_vec,output=self.density(cart,neigh_list,shifts,species)
        print(self.density.initpot)
        output = output+self.density.initpot
